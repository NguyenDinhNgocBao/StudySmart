                    ...
                    startButtonClick = {
                        if(state.subjectId != null && state.relatedToSubject != null){
                            ServiceHelper.triggerForegroundService(
                                context = context,
                                action = if(currentTimeState == STARTED){
                                    ACTION_SERVICE_STOP
...
private fun RelatedToSubject(
    ...
    Column(
        ...
        Row(
            ...
            Text(text = "Viet Nam", style = MaterialTheme.typography.bodySmall)
            IconButton(
...
private fun ButtonSection(
    ...
    Row(
        ...
        Button(
            ...
            enabled = seconds != "00" && timerstate != STARTED
        ) {
            Text(
        ...
        Button(
            ...
            colors = ButtonDefaults.buttonColors(
                containerColor = if(timerstate == STARTED) Red else MaterialTheme.colorScheme.primary,
