...
import com.example.studysmart.presentation.components.AddSubject
...
import com.example.studysmart.presentation.data.Data
        ...
        LazyColumn(
            ...
            item {
                CountCardsSection(
                    ...
                    studiedCount = state.totalStudiedHours.toString(),
            ...
            tasksList(
                ...
                tasks = tasks,
                onCheckBoxClick = {onEvent(DashboardEvent.OnTaskIsCompletedChag(it))},
